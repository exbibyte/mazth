...
fn test_mat4() {
    ...
    }
    {
        ...
        let v3 = Mat3 {
            _val: [
                45f64, 48f64, 51f64, 162f64, 174f64, 186f64, 279f64, 300f64, 321f64,
            ],
            _is_row_major: true,
        };
    ...
    }
    {
        ...
        assert!(v2
            .is_equal(
                &Mat3 {
                    _val: [0f64, 3f64, 6f64, 1f64, 4f64, 7f64, 2f64, 5f64, 8f64],
                    _is_row_major: true
                },
                0.0001f64
            )
            .expect("mat3 is_equal invalid"));
    }
    {
        //identity
        ...
        assert!(v1
            .is_equal(
                &Mat3 {
                    _val: [1f64, 0f64, 0f64, 0f64, 1f64, 0f64, 0f64, 0f64, 1f64],
                    _is_row_major: true
                },
                0.0001f64
            )
