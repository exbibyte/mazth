...
fn test_mat1x4() {
...

    {
...

        {
            ...
            assert!(v3
                .is_equal(&Mat1x4 { _val: [20f64; 4] }, 0.0001f64)
                .expect("Mat1x4 is_equal invalid"));
        }
        {
            let v3 = v.div(&v2).expect("div result invalid");
            assert!(v3
                .is_equal(&Mat1x4 { _val: [5f64; 4] }, 0.0001f64)
                .expect("Mat1x4 is_equal invalid"));
        }
        {
            let v3 = v.plus(&v2).expect("plus result invalid");
            assert!(v3
                .is_equal(&Mat1x4 { _val: [12f64; 4] }, 0.0001f64)
                .expect("Mat1x4 is_equal invalid"));
        }
        {
            let v3 = v.minus(&v2).expect("plus result invalid");
            assert!(v3
                .is_equal(&Mat1x4 { _val: [8f64; 4] }, 0.0001f64)
                .expect("Mat1x4 is_equal invalid"));
        }
